...
void create_m2(const double* matrixA, const double* matrixB, int n, int steps_left, double* m2)
{
	...
	mkl_domatcopy('R', 'N', n / 2, n / 2, 1, matrixB, n, b11, n / 2);
...
void create_m3(const double* matrixA, const double* matrixB, int n, int steps_left, double* m3)
{
	...
	mkl_domatcopy('R', 'N', n / 2, n / 2, 1, matrixA, n, a11, n / 2);
	//printf("A11:\n:");
	//printMatrix(a11, n / 2);
...
void create_m4(const double* matrixA, const double* matrixB, int n, int steps_left, double* m4)
{
	...
	mkl_domatcopy('R', 'N', n / 2, n / 2, 1, &matrixA[n * n / 2 + n / 2], n, a22, n / 2);
	//printf("A22:\n:");
	//printMatrix(a22, n / 2);
...
void create_m5(const double* matrixA, const double* matrixB, int n, int steps_left, double* m5)
{
	...
	mkl_domatadd('R', 'N', 'N', n / 2, n / 2, 1, matrixA, n, 1, &matrixA[n / 2], n, add_a11_a12, n / 2);
	//printf("A11+A12:\n:");
	...
	mkl_domatcopy('R', 'N', n / 2, n / 2, 1, &matrixB[n * n / 2 + n / 2], n, b22, n / 2);
	//printf("B22:\n:");
	//printMatrix(b22, n / 2);
...
*/
inline double* create_zero_mat(int dim)
{
	double* mat = (double *) mkl_malloc(dim * dim * sizeof(double), 64);
